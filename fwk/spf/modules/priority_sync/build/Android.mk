...
include $(CLEAR_VARS)
LOCAL_MODULE := capi_priority_sync_headers
...
LOCAL_SRC_FILES := \
    capi/src/capi_priority_sync.c \
    capi/src/capi_priority_sync_control_utils.c \
    capi/src/capi_priority_sync_data_utils.c \
    capi/src/capi_priority_sync_event_utils.c \
    capi/src/capi_priority_sync_ts.c
