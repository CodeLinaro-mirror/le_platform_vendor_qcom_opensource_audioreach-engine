...
include $(CLEAR_VARS)
LOCAL_MODULE := lib_vol_ctrl_lib_headers
...
LOCAL_HEADER_LIBRARIES := lib_spm_cmn_utils_headers libposal_headers libspf_interfaces_headers libspf_api
LOCAL_STATIC_LIBRARIES := lib_spm_cmn_utils libposal libspf_interfaces
